"""
Django settings for schedulepro project.
...
SECRET_KEY = 'django-insecure-rclja_cr*(8_)%ou^xbg=^4yn63cy^3$71@u#q+%&ys*gbnp*i'
...
MIDDLEWARE = [
    ...
    # Ensure this exact path is used:
...
WSGI_APPLICATION = 'schedulepro.wsgi.application'
